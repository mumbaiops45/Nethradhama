          ...
          <div className="mt-10 grid gap-7 sm:grid-cols-2 lg:grid-cols-3">
            {facilities.map((f, i) => (
              <Reveal key={f.title} delay={i * 90}>
                <div className="group relative h-full overflow-hidden rounded-2xl border border-stone-200 bg-white p-7 shadow-sm transition-all duration-500 hover:-translate-y-2 hover:border-[#0D8DD7]/40 hover:shadow-[0_24px_60px_-15px_rgba(13,141,215,0.28)]">
                  ...
                  <div className="relative grid h-12 w-12 place-items-center rounded-xl bg-[#0D8DD7]/10 text-[#0D8DD7] transition-all duration-500 group-hover:scale-105 group-hover:bg-[#0D8DD7] group-hover:text-white">
                    {f.icon("h-6 w-6")}
                  </div>
                  <h3 className="relative mt-5 text-xl font-semibold text-slate-900 transition-colors duration-300 group-hover:text-[#0D8DD7]">
                    {f.title}
                  </h3>
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {academics.map((a, i) => (
              <Reveal key={a.k} delay={i * 60}>
                <div className="group relative h-full overflow-hidden rounded-2xl border border-stone-200 bg-white p-7 shadow-sm transition-all duration-500 hover:-translate-y-1.5 hover:border-[#0D8DD7]/30 hover:shadow-xl">
                  <div className="pointer-events-none absolute -right-16 -top-16 h-40 w-40 rounded-full bg-[#0D8DD7]/0 blur-3xl transition-all duration-700 group-hover:bg-[#0D8DD7]/12" />
                  <div className="relative flex items-center gap-2 text-sm font-semibold uppercase tracking-wider text-[#0D8DD7]">
                    <span className="h-2 w-2 rounded-full bg-[#0D8DD7]" />
                    {a.k}
                  </div>
                  <p className="relative mt-4 text-sm leading-relaxed text-slate-600">{a.v}</p>
                  <div className="mt-6 h-px w-0 bg-gradient-to-r from-[#0D8DD7] to-transparent transition-all duration-500 group-hover:w-full" />
                </div>
              </Reveal>
            ))}
