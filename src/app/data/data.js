...
export const services = [
    ...
    { icon: Stethoscope, title: "Clinical Internship", desc: "A compulsory one-year internship at Nethradhama Super Speciality Eye Hospital." },
    { icon: FlaskConical, title: "Research Programs", desc: "UG research projects supported by RGUHS grants, building a strong evidence-based foundation." },
    { icon: Glasses, title: "Contact Lens & Low Vision", desc: "Specialty clinics in contact lens fitting, low-vision aids and visual rehabilitation." },
    { icon: Baby, title: "Pediatric & Binocular Vision", desc: "Focused modules on children's vision, squint evaluation and binocular vision therapy." },
    { icon: Users, title: "Community Outreach", desc: "Vision-screening camps that take eye care to schools and underserved communities." },
];
